...
: ${AMENT_CURRENT_PREFIX:="/mnt/emmc/cat_home/arm-platform/install/manipulator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/manipulator/environment/library_path.sh"
